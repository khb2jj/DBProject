...
<body>
    <div class="form">
        ...
        <form name="form" method="post" action="">
            ...
            <p><input type="text" name="a" placeholder="Return ID" required /></p>
            <p><input type="text" name="b" placeholder="Customer ID" required /></p>
            <p><input type="text" name="c" placeholder="Product ID" required /></p>
            <p><input type="text" name="d" placeholder="Return Date" required /></p>
