...
<html>
    ...
    <div class="w3-container">
        <button style="font-size: 20px; background-color:yellow; border: solid 2px; border-radius: 5px;" onClick='location.href="addPurchases.php"'>Insert Purchase <i class="fa fa-arrow-right"></i></button>
        <div style="float:right">
            <label style="font-size: 20px;" for="myInput">Search by Date</label>
